...
public:
    ...
    /**
     * Retrieves the QML representation of the materials for the skeleton.
     *
     * This method generates the QML code that represents the materials for the skeleton.
     * The representation is in the form of a QML array that contains PrincipledMaterial objects.
     * The materialId follows this convention:
     *
     * "material.[agentInstanceId].[boneName]"
     *
     * @param agentInstanceId The unique identifier of the agent instance.
     * @return The QML representation of the materials. If the root bone is not found, an empty string is returned.
     *
     * @see PrincipledMaterial, BrainiacGlobals::BrainiacId
     */
    [[nodiscard]] QString materialsQML(BrainiacGlobals::BrainiacId agentInstanceId) const;

    /**
     * Retrieves the QML representation of the skeleton.
     * The skeleton QML is generated by traversing the bone hierarchy, starting from the root bone.
...
private:
     ...
     * Each ID corresponds to a BoneBox object in the Body. This is important because the IDs of a given bone differ
